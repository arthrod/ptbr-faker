...
def test_location_sampler_initialization(mock_location_data):
...
def test_get_state(mock_location_data):
...
def test_get_city(mock_location_data):
...
def test_get_state_and_city(mock_location_data):
...
def test_cep_formatting(mock_location_data):
    """Test CEP formatting."""
    sampler = BrazilianLocationSampler(mock_location_data)
...
def test_random_cep_generation(mock_location_data):
...
def test_full_location_format(mock_location_data):
...
def test_random_location_options(mock_location_data):
